...
export const DirectorRelatedFilings = {
  id: "director-related-filings",
  slug: "director-related-filings",
  ...
  hero: {
    title: "Director-Related Filings",
    description: "Get assistance with applicable MCA filings and documentation relating to company directors and changes in director information.",
    ...
    highlights: [
      { icon: Building2, text: "MCA Assistance" },
      { icon: Users, text: "Document Preparation" },
      { icon: Folder, text: "Filing Support" },
      { icon: MessageCircle, text: "Compliance Guidance" },
    ],
  },

  overview: {
    title: "Who is Director-Related Filings for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "2",
        title: "Director Data Collection",
        variant: "lucide",
        icon: Users,
      },
      {
