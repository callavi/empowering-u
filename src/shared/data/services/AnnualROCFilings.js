...
export const AnnualROCFilings = {
  id: "annual-roc-filings",
  slug: "annual-roc-filings",
  ...
  hero: {
    ...
    highlights: [
      { icon: Headset, text: "Annual Compliance" },
      { icon: Clock, text: "ROC Filing Support" },
  ...
  overview: {
    title: "Who is Annual ROC Filings for?",
