...
export const NDAConfidentialityAgreements = {
  id: "nda-confidentiality-agreements",
  slug: "nda-confidentiality-agreements",
  ...
  hero: {
    ...
    highlights: [
      { icon: Headset, text: "Confidentiality Support" },
      { icon: Clock, text: "Clear Terms" },
      { icon: Send, text: "Document Preparation" },
      { icon: Building2, text: "Guided Assistance" },
    ],
  },

  overview: {
    title: "Who is NDA / Confidentiality Agreements for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "2",
        title: "Information Scope Review",
        variant: "lucide",
        icon: Clock,
      },
      {
