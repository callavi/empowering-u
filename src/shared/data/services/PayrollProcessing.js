...
export const PayrollProcessing = {
  ...
  hero: {
    ...
    highlights: [
      { icon: Clock, text: "Payroll Processing" },
      { icon: Send, text: "Salary Calculations" },
      { icon: Building2, text: "Record Support" },
      { icon: Users, text: "Timely Assistance" },
    ],
  },

  overview: {
    title: "Who is Payroll Processing for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "2",
        title: "Attendance & Salary Review",
        variant: "lucide",
        icon: Send,
      },
      {
      ...
      {
        id: "4",
        title: "Payslip / Payroll Finalization",
        variant: "lucide",
        icon: Users,
      },
    ],
