...
export const EmployeeDocumentation = {
  id: "employee-documentation",
  slug: "employee-documentation",
  ...
  hero: {
    ...
    highlights: [
      { icon: Send, text: "Document Organization" },
      { icon: Building2, text: "HR Support" },
      { icon: Users, text: "Structured Records" },
      { icon: Folder, text: "Guided Assistance" },
    ],
  },

  overview: {
    title: "Who is Employee Documentation for?",
