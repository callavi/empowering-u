...
export const BusinessAgreements = {
  ...
  hero: {
    ...
    highlights: [
      { icon: BadgeCheck, text: "Business-Focused Drafting" },
      { icon: FileText, text: "Clear Documentation" },
      { icon: ShieldCheck, text: "Review Support" },
      { icon: Headset, text: "Guided Process" },
    ],
  },

  overview: {
    title: "Who is Business Agreements for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "2",
        title: "Commercial Terms Collection",
        variant: "lucide",
        icon: FileText,
      },
      {
