...
export const ESICCompliance = {
  ...
  hero: {
    ...
    highlights: [
      { icon: FileText, text: "ESIC Support" },
      { icon: ShieldCheck, text: "Payroll Review" },
      { icon: Headset, text: "Filing Assistance" },
      { icon: Clock, text: "Compliance Guidance" },
    ],
  },

  overview: {
    title: "Who is ESIC Compliance for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "3",
        title: "Contribution Preparation",
        variant: "lucide",
        icon: Headset,
      },
      {
