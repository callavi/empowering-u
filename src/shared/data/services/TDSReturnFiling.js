...
export const TDSReturnFiling = {
  ...
  hero: {
    ...
    highlights: [
      { icon: Folder, text: "TDS Review" },
      { icon: MessageCircle, text: "Return Preparation" },
      { icon: BadgeCheck, text: "Filing Assistance" },
      { icon: FileText, text: "Compliance Support" },
    ],
  },

  overview: {
    title: "Who is TDS Return Filing for?",
