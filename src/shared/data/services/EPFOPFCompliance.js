...
export const EPFOPFCompliance = {
  id: "epfo-pf-compliance",
  slug: "epfo-pf-compliance",
  ...
  hero: {
    ...
    highlights: [
      { icon: BadgeCheck, text: "PF Compliance" },
      { icon: FileText, text: "Record Support" },
      { icon: ShieldCheck, text: "Filing Assistance" },
      { icon: Headset, text: "Guided Process" },
    ],
  },

  overview: {
    title: "Who is EPFO / PF Compliance for?",
