...
export const GSTNoticeResponse = {
  id: "gst-notices-response-support",
  slug: "gst-notices-response-support",
  ...
  hero: {
    title: "GST Notices & Response Support",
    description: "Get assistance reviewing GST notices and preparing an appropriate response based on the records and information available.",
    ...
    highlights: [
      { icon: Send, text: "Notice Review" },
      { icon: Building2, text: "Response Assistance" },
      { icon: Users, text: "Document Support" },
      { icon: Folder, text: "Guided Process" },
    ],
  },

  overview: {
    title: "Who is GST Notices & Response Support for?",
