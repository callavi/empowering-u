...
export const EInvoicingEWayBillSupport = {
  id: "e-invoicing-e-way-bill-support",
  slug: "e-invoicing-e-way-bill-support",
  ...
  hero: {
    title: "E-Invoicing / E-Way Bill Support",
    description: "Get assistance with applicable e-invoicing and e-way bill processes for GST-compliant business transactions.",
    ...
    highlights: [
      { icon: Clock, text: "Process Guidance" },
      { icon: Send, text: "Invoice Support" },
      { icon: Building2, text: "Compliance Assistance" },
      { icon: Users, text: "Practical Support" },
    ],
  },

  overview: {
    title: "Who is E-Invoicing / E-Way Bill Support for?",
  ...
  process: {
    ...
    features: [
      ...
      {
        id: "3",
        title: "Document Generation Support",
        variant: "lucide",
        icon: Building2,
      },
      {
  ...
  documents: [
    {
      ...
      list: [
        ...
        "Transport details, where applicable",
