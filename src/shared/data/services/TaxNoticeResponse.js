...
export const TaxNoticeResponse = {
  id: "tax-notices-response-assistance",
  slug: "tax-notices-response-assistance",
  ...
  hero: {
    title: "Tax Notices & Response Assistance",
    description: "Get assistance reviewing income-tax related notices and preparing a response based on available records.",
    ...
    highlights: [
      { icon: FileText, text: "Notice Review" },
      { icon: ShieldCheck, text: "Response Assistance" },
      { icon: Headset, text: "Record Support" },
      { icon: Clock, text: "Guided Process" },
    ],
  },

  overview: {
    title: "Who is Tax Notices & Response Assistance for?",
